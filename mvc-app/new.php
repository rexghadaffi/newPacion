...
Enterprise
Blog
 Watch 593  Star 4,415  Fork 1,671 olton/Metro-UI-CSS
Branch: master  Metro-UI-CSS/docs/validator.html
@oltonolton 11 days ago upd validator event binding model
1 contributor
RawBlameHistory     599 lines (566 sloc)  29.736 kB
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
                ...
                <div class="row cells2">
                    <div class="cell">
                        <form data-role="validator" data-on-submit="return false">
                            <label class="block">data-on-submit: return false</label>
                            <div class="input-control text">
                                <input type="text" data-validate-func="required" data-show-error-hint="false">
                                <span class="input-state-error mif-warning"></span>
                                <span class="input-state-success mif-checkmark"></span>
                            </div>
                            <div>
                    ...
                    <div class="cell">
                        <form data-role="validator" data-on-submit="return true">
                            <label class="block">data-on-submit: return true</label>
                            <div class="input-control text">
                                <input type="text" data-validate-func="required" data-show-error-hint="false">
                                <span class="input-state-error mif-warning"></span>
                                <span class="input-state-success mif-checkmark"></span>
