  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header btn-custom" >
        ...
        <h4 class="modal-title" id="myModalLabel" style="color:white;font-size:24px" align="center">Add New Topic</h4>
      </div>
	   <form method="POST" >
   ...
   <div class="modal-footer">
			...
			<button type="submit" class="btn btn-success btn-lg" name="btntopic">Post</button>
		  </div>
		</div>  
	  </form>
    </div>
