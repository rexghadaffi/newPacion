...
<link rel="stylesheet" type="text/css" href="shared-resources/resources/demo.css">
  ...
  <div class="container"  style="margin-top:8%;background-color:#E8E8E8 ;padding-top:3%;padding-bottom:3%;width:40%">
 ...
 <div class="row">
  ...
  <div class=" col-md-6">
      ...
      <button type="submit" name="btnlogin" id="btnLogin" class="btn btn-primary btn-lg" style="margin-right:15%">Sign in</button>
