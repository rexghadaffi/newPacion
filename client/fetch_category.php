...
<div class="panel panel-info">
	...
	<div class="panel-heading">
		<h3 class="panel-title"> '.$row["forumCatTitle"].';
...
<p class="col-md-3"><i class="fa fa-calendar fa-fw"></i>Date Created</b></p>';
	...
	if($row["forumCatID"] == $tpc["forumCatID"])
		{
		echo '';
		echo '<p class="col-md-5"><a href="?page=topic&action=display&topicid='.$tpc["topicID"].'"><i class="fa fa-link fa-fw"></i>'.$tpc["topicTitle"].'</p></a>';	
