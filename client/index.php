...
?>
	<section id="featured" style="background-color: blue;">
	<!-- start slider -->
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
...
-->
	...
	<section class="callaction" style="background-color: #FFFF00;">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="big-cta">
...
<div class="col-lg-4" style="background-color: white; height: 450px; padding: 5px;">
<div class="media">
